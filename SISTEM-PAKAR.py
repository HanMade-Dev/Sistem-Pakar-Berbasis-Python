...
class DiagnosisExpertSystem:
    ...
    def diagnose(self, selected_gejala):
        ...
        results = []
        # Calculate match percentage for all diseases
        for rule in self.rules:
            ...
            # Add all diseases to results, regardless of percentage
            results.append({
...
class MainMenuFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Add a back button to the header (optional for main menu)
        ...
        back_button.pack_forget()  # Hide it on main menu
...
class DiagnosisFrame(tk.Frame):
    ...
    def setup_diagnosis_page(self):
        ...
        # Add all symptoms directly without categories
...
class ResultFrame(tk.Frame):
    ...
    def display_results(self, results):
        ...
        for i, result in enumerate(filtered_results):
            ...
            # Display percentage for all diseases
